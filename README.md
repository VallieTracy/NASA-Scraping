...
7.) After you've navigated to the page, click 'Scrape New Data' and the page will update with: 

    a.) NASA's most current Featured Mars Image,     
    b.) Mars Weather,  
    c.) and the latest Mars headline! (*see Note 1 below*)      
